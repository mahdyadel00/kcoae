...
@section('content')
    ...
    <div id="content" class="main-content">
        <!--  BEGIN BREADCRUMBS  -->
        @include('admin.layouts.secondary_nav',['title'=>'التواصل الاجتماعي ','sub_title'=>'إضافة'])
        <br>
        <!--  END BREADCRUMBS  -->
                ...
                <div class="user-profile ">
                    <div class="widget-content widget-content-area">
                            <h3 class="mt-4"> </h3>
                                ...
                                <form class=" g-3" method="post" action="{{route('admin_panel.social.store')}}" enctype="multipart/form-data" >
                                    @method('POST')
                                    @csrf
                                    @if ($errors->any())
