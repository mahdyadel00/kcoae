...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu {{ ( (request()->is('*/users*'))|| (request()->is('*/admins*')) || (request()->is('*/create_user')) )? 'active' : '' }}">
                    ...
                    <ul class="collapse submenu list-unstyled {{  ( (request()->is('*/users*'))  || (request()->is('*/admins*')) || (request()->is('*/create_user')) ) ? 'show' : ''}}" id="dashboard" data-bs-parent="#accordionExample">
                        <li class="{{ (request()->is('*/admins*')) ? 'active' : '' }}">
                            <a href="{{route('admin_panel.admins.index')}}"> مدراء الموقع </a>
                        </li>
                    </ul>
                    <ul class="collapse submenu list-unstyled {{ ( (request()->is('*/users*')) || (request()->is('*/admins*')) || (request()->is('*/create_user')) ) ? 'show' : ''}}" id="dashboard" data-bs-parent="#accordionExample">
                        <li class="{{  ( (request()->is('*/users*')) || (request()->is('*/create_user')) ) ? 'active' : '' }}">
                            <a href="/admin_panel/users"> المستخدمون  </a>
                        </li>
                    </ul>
                </li>
            @else
            ...
            <li class="menu {{ ( (request()->is('*/about*'))|| (request()->is('*/employees*'))|| (request()->is('*/emp_notes*')) )? 'active' : '' }}">
                <a href="#office" data-bs-toggle="collapse" aria-expanded="{{(  (request()->is('*/about*'))|| (request()->is('*/employees*'))|| (request()->is('*/emp_notes*'))  ) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{  ( (request()->is('*/about*'))  || (request()->is('*/employees*'))|| (request()->is('*/emp_notes*')) ) ? 'show' : ''}}" id="office" data-bs-parent="#accordionExample">
                    <li class="{{ (request()->is('*/about*')) ? 'active' : '' }}">
                        <a href="{{route('admin_panel.about.index')}}"> نبذة تعريفية </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled {{ ( (request()->is('*/about*')) || (request()->is('*/employees*'))|| (request()->is('*/emp_notes*'))  ) ? 'show' : ''}}" id="office" data-bs-parent="#accordionExample">
                    <li class="{{  ((request()->is('*/employees*'))||(request()->is('*/emp_notes*'))) ? 'active' : '' }}">
                        <a href="{{route('admin_panel.employees.index')}}"> موظفي المكتب  </a>
                    </li>
                </ul>
            </li>
...
-->
            ...
            <li class="menu {{ ( (request()->is('*/news*')) || (request()->is('*/certifications')) || (request()->is('*/questions*')) )? 'active' : '' }}">

                <a href="#staticPage" data-bs-toggle="collapse" aria-expanded="{{(  (request()->is('*/news*'))|| (request()->is('*/certifications*'))|| (request()->is('*/questions*')) ) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>الصفحة الأساسية </span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/.svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                    </div>
                ...
                <li class="menu {{ (request()->is('*/news*')) ? 'active' : '' }}" id="staticPage" data-bs-parent="#accordionExample">
                ...
                <li class="menu {{ (request()->is('/certifications')) ? 'active' : '' }}" id="staticPage" data-bs-parent="#accordionExample">
                    <a href="{{route('admin_panel.certifications.index')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-key"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>
                ...
                <li class="menu {{ (request()->is('*/questions*')) ? 'active' : '' }}" id="staticPage" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ ( (request()->is('*/orders*'))|| (request()->is('*/certifications*'))|| (request()->is('*/order_notes*')) )? 'active' : '' }}">
                <a href="#gate" data-bs-toggle="collapse" aria-expanded="{{( (request()->is('*/orders*'))|| (request()->is('*/certifications*'))|| (request()->is('*/order_notes*')) ) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{  ( (request()->is('*/orders*'))|| (request()->is('*/certifications*'))|| (request()->is('*/order_notes*')) ) ? 'show' : ''}}" id="gate" data-bs-parent="#accordionExample">
                    <li class="{{ ((request()->is('*/orders*'))|| (request()->is('*/order_notes*'))) ? 'active' : '' }}">
            ...
            <li class="menu {{ ( (request()->is('*/metas*'))|| (request()->is('*/working_days*')) )? 'active' : '' }}">
                <a href="#settings" data-bs-toggle="collapse" aria-expanded="{{(  (request()->is('*/metas*'))|| (request()->is('*/working_days*'))  ) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{  ( (request()->is('*/metas*'))  || (request()->is('*/working_days*')) ) ? 'show' : ''}}" id="settings" data-bs-parent="#accordionExample">
                    <li class="{{ (request()->is('*/metas*')) ? 'active' : '' }}">
                        <a href="{{route('admin_panel.metas.index')}}">الإعدادات </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled {{ ( (request()->is('*/metas*')) || (request()->is('*/working_days*'))  ) ? 'show' : ''}}" id="settings" data-bs-parent="#accordionExample">
                    <li class="{{  (request()->is('*/working_days*')) ? 'active' : '' }}">
                        <a style="white-space: break-spaces;" href="{{route('admin_panel.working_days.index')}}"> دوام العمل و العطلات الرسمية  </a>
                    </li>
                </ul>
            </li>
