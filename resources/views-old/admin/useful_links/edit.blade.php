...
@section('content')
    ...
    <div id="content" class="main-content">
        <!--  BEGIN BREADCRUMBS  -->
        @include('admin.layouts.secondary_nav',['title'=>'روابط مفيدة','sub_title'=>'تعديل'])
        <br>
        <!--  END BREADCRUMBS  -->
                ...
                <div class="user-profile ">
                    <div class="widget-content widget-content-area">
                            <h3 class="mt-4"> </h3>
                                ...
                                <form class=" g-3" method="post" action="{{route('admin_panel.useful_links.update',$useful_link->id)}}" enctype="multipart/form-data" >
                                    @method('PATCH')
                                    @csrf
                                    @if ($errors->any())
...
{{--                                            <i class=" {{$social->icon}}"></i>--}}
                                            ...
                                            <button name="icon" class="btn btn-secondary" role="iconpicker" value="{{$useful_link->icon}}"></button>
                                        </div>

                                        <div class="col-md-12 mt-4">
                                            <label for="inputEmail4" class="form-label">العنوان </label>
                                            <input type="text" class="form-control"  name="title" value="{{$useful_link->title}}">
                                        </div>

                                        <div class="col-md-12 mt-4">
                                            <label for="inputEmail4" class="form-label">الرابط </label>
                                            <input type="url" class="form-control"  name="link" value="{{$useful_link->link}}">
                                        </div>
