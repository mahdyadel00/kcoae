...
@section('content')
    ...
    <div id="content" class="main-content">
        <!--  BEGIN BREADCRUMBS  -->
        @include('admin.layouts.secondary_nav',['title'=>'لائحة البعثات ','sub_title'=>'إضافة بعثة'])
        <br>
        <!--  END BREADCRUMBS  -->
        <div class="layout-spacing">
            ...
            <div class="col-12">
                <div class="user-profile ">
                    ...
                    <h3 class="mt-4"> </h3>
                        <form class="g-3" method="post" action="{{route('admin_panel.missions.store')}}" enctype="multipart/form-data" >
                            @method('POST')
                            @csrf
                            @if ($errors->any())
