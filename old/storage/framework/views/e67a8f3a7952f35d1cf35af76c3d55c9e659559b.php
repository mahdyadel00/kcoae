                            ...
                            <?php $__currentLoopData = $guides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-6 pb-4">
                                    <div class="lists">
                                        ...
                                        <span><a href="/<?php echo e($guide->file); ?>" target="_blank"><?php echo e($guide->name); ?></a></span>
                                    </div>
                                </div>
...
<?php echo $__env->make('cultural_center.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kcoae/stage.kco.ae/center/resources/views/cultural_center/student_guide.blade.php ENDPATH**/ ?>