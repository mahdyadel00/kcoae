<?php $__env->startSection('content'); ?>
    ...
    <div id="content" class="main-content">
        <!--  BEGIN BREADCRUMBS  -->
        <?php echo $__env->make('admin.layouts.secondary_nav',['title'=>'التواصل الاجتماعي ','sub_title'=>'تعديل'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <br>
        <!--  END BREADCRUMBS  -->
                ...
                <div class="user-profile ">
                    <div class="widget-content widget-content-area">
                            <h3 class="mt-4"> </h3>
                                ...
                                <form class=" g-3" method="post" action="<?php echo e(route('admin_panel.social.update',$social->id)); ?>" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button name="icon" class="btn btn-secondary" role="iconpicker" value="<?php echo e($social->icon); ?>"></button>
                                        </div>
                                        <div class="col-md-12 mt-4">
                                            <label for="inputEmail4" class="form-label">الرابط </label>
                                            <input type="url" class="form-control"  name="link" value="<?php echo e($social->link); ?>">
                                        </div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kcoae/stage.kco.ae/center/resources/views/admin/social/edit.blade.php ENDPATH**/ ?>