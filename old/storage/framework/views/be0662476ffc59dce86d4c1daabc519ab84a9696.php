        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl btco-hover-menu">
                <a class="navbar-brand logo" href="#">
                    <div class="nav-logo">
                    <img src="<?php echo e(asset($meta->header_logo)); ?>" alt="">
                    </div>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navmenu">
                    ...
                    <div class="button sign-1">
                        ...
                        <?php if(auth('client')->user()): ?>
                          <ul class="navbar-nav">
                                    <li>
                                        <a class="dropdown-item dropdown-toggle pr-4" href="#"
                                            data-toggle="dropdown"><?php echo e(auth('client')->user()->name); ?> </a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo e(route('orders.index')); ?>">طلباتي</a></li>
                        ...
                        <?php else: ?>
                            <a href="/register" class="btn btn-button btn-button-1 popin black-bg" >
...
<?php /**PATH /home/kcoae/stage.kco.ae/center/resources/views/cultural_center/layouts/navigation.blade.php ENDPATH**/ ?>