<?php $__env->startSection('content'); ?>
    ...
    <div id="content" class="main-content">
        <!--  BEGIN BREADCRUMBS  -->
        <?php echo $__env->make('admin.layouts.secondary_nav',['title'=>'روابط مفيدة','sub_title'=>'إضافة'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <br>
        <!--  END BREADCRUMBS  -->
                ...
                <div class="user-profile ">
                    <div class="widget-content widget-content-area">
                            <h3 class="mt-4"> </h3>
                                ...
                                <form class=" g-3" method="post" action="<?php echo e(route('admin_panel.useful_links.store')); ?>" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="inputEmail4" class="form-label">الأيقونة </label>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kcoae/stage.kco.ae/center/resources/views/admin/useful_links/create.blade.php ENDPATH**/ ?>