...
use App\Http\Controllers\Admin\CircularsController;
...
//Route::get('/confirmation', [HomeController::class,'showConfirmation']);
...
//get universutes belongs to specific country
