...
class HomeController extends Controller
{
    ...
    function index () {
        ...
        return view ('cultural_center.welcome',['news'=>$news,'sliders'=>$sliders,'application_form'=>$application_form,'instructions'=>$instructions,'circulars'=>$circulars]);
    }
    ...
    function showList () {
        ...
        return view ('cultural_center.list');
    }
    ...
    function showWorker () {
        ...
        return view ('cultural_center.worker',['employees'=>$employees]);
    }
